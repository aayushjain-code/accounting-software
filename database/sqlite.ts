...
export class SQLiteManager {
  ...
  createClient(client: Omit<any, "id" | "createdAt" | "updatedAt">) {
  ...
  updateClient(id: number, client: Partial<any>) {
  ...
  createProject(project: Omit<any, "id" | "createdAt" | "updatedAt">) {
    const stmt = this.db.prepare(`
  ...
  updateProject(id: number, project: Partial<any>) {
  ...
  createTimesheet(timesheet: Omit<any, "id" | "createdAt" | "updatedAt">) {
    const stmt = this.db.prepare(`
  ...
  updateTimesheet(id: number, timesheet: Partial<any>) {
  ...
  createInvoice(invoice: Omit<any, "id" | "createdAt" | "updatedAt">) {
    const stmt = this.db.prepare(`
  ...
  updateInvoice(id: number, invoice: Partial<any>) {
  ...
  createExpense(expense: Omit<any, "id" | "createdAt" | "updatedAt">) {
    const stmt = this.db.prepare(`
  ...
  updateExpense(id: number, expense: Partial<any>) {
  ...
  updateCompanyProfile(profile: Partial<any>) {
  ...
  getStatistics() {
    const stats: any = {
      totalClients: (
        this.db.prepare("SELECT COUNT(*) as count FROM clients").get() as any
      ).count,
      totalProjects: (
        this.db.prepare("SELECT COUNT(*) as count FROM projects").get() as any
      ).count,
      totalTimesheets: (
        this.db.prepare("SELECT COUNT(*) as count FROM timesheets").get() as any
      ).count,
      totalInvoices: (
        this.db.prepare("SELECT COUNT(*) as count FROM invoices").get() as any
      ).count,
      totalExpensesCount: (
        this.db.prepare("SELECT COUNT(*) as count FROM expenses").get() as any
      ).count,
      totalRevenue:
        (
          this.db
